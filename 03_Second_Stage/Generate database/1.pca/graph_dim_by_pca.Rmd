...
Las versiones 3, 4 y 5 son estandarizaciones de variables
...
## 5.4. Dimensión características del hogar

### Versión 1
```{r}
fviz_pca_var(house.characteristics.pca_1, 
             col.var = 'contrib',
             repel = TRUE # Do not overlap text
             )
```
### Versión 2
```{r}
fviz_pca_var(house.characteristics.pca_2, 
             col.var = 'contrib',
             repel = TRUE # Do not overlap text
             )
```
...
## 5.5. Dimensión dinámica poblacional

### Versión 1
```{r}
fviz_pca_var(dynamic.population.pca_1, 
             col.var = 'contrib',
             repel = TRUE # Do not overlap text
             )
```
### Versión 2
```{r}
fviz_pca_var(dynamic.population.pca_2, 
             col.var = 'contrib',
             repel = TRUE # Do not overlap text
             )
```
...
### Versión 3
```{r}
fviz_pca_var(dynamic.population.pca_3, 
             col.var = 'contrib',
             repel = TRUE # Do not overlap text
             )
```
...
## 5.6. Dimensión geográfica

### Versión 1
```{r}
fviz_pca_var(geographic.pca_1, 
             col.var = 'contrib',
             repel = TRUE # Do not overlap text
             )
```
...
## 5.7. Versiones de los mejores modelos (sin dimensión geográfica)

### Año 2020 (Mujeres)
Las versiones de la dimensión económica, demográfica, educación y salud son estandarizaciones de variables
...
### Año 2021 (Mujeres)
Las versiones de la dimensión demográfica, educación y salud son estandarizaciones de variables
...
### Año 2021 (Hombres)
Las versiones de la dimensión demográfica y educación son estandarizaciones de variables
...
## 5.8. Versiones de los mejores modelos (con dimensión geográfica)
