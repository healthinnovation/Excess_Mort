...
db         <- readRDS("./1.pca/01_DB/social_dets_dep.rds")
db.prov    <- readRDS("./1.pca/01_DB/vulnr_df_prov.rds")

load("./1.pca/01_DB/vulnerabilidad.RData")
...
# Climatic data
 ...
 db.no2          <-  readRDS("no2_2020-2021.rds")          %>%
                     ungroup()                             %>%
                     rename(year  = anio,
                        month = mes,
                        no2   = NO2)             %>% 
                     arrange(reg,prov,year,month,no2)
...
db.men.post  <- db.men                                                                       %>% 
                ...
                left_join(db.no2     ,by           = c(   "reg"="reg" , "prov"="prov",
                                                       "year"="year","month"="month"))       %>%
...
```{r}
db<-readRDS("./2.output_db/db_women_fulldim_2021.rds")
